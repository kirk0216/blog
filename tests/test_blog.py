...
def test_create(client, auth, app):
    ...
    client.post('/create', data={'title': 'created', 'body': 'created body'})
...
def test_update(client, auth, app):
    ...
    client.post('/1/update', data={'title': 'updated', 'body': 'updated body'})
...
def test_create_update_validate(client, auth, path):
    ...
    assert b'Title: This field is required.' in response.data
    assert b'Body: This field is required.' in response.data
